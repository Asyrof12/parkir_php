-- ==========================================
-- SCRIPT DATABASE PARKIR WISNU (FINAL FIX)
-- ==========================================
...
-- 2. Hapus Tabel Lama (Urutan terbalik dari Foreign Key)
...
-- 10. Isi Data Master (Opsional)
INSERT INTO `tb_tarif` (`jenis_kendaraan`, `tarif_per_jam`) VALUES
('motor', 2000),
('mobil', 5000),
('lainnya', 10000);

INSERT INTO `tb_area_parkir` (`nama_area`, `kapasitas`) VALUES
('Area A1', 50),
('Area B1', 30);
